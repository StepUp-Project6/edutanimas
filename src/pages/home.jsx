  ...
  const items = [
    {
      ...
      description:
        "Kegiatan Tani Mas diawali dengan Sosialisasi Pertanian Masuk Sekolah di Dinas Pangan Provinsi yang bersangkutan dilanjutkan dengan pendampingan penyusunan RAB di sekolah penerima kegiatan.",
    },
    {
      title: "Rapat Koordinasi",
      description:
        "Dalam rapat tersebut, Dinas Pangan Provinsi menyampaikan materi terkait Pertanian Masuk Sekolah (PMS), BPTP menyampaikan materi teknologi budidaya tanaman hortikultura ramah lingkungan.",
    },
    {
      title: "Komoditas",
      description:
        "Tim sosialisasi berupaya membangkitkan minat siswa agar mau bertani sebagai salah satu solusi dari masalah regenerasi petani di masa mendatang dan sebagai media pembelajaran siswa untuk mengetahui bidang pertanian.",
    },
  ];
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <img
        ...
        alt="bg"
        className="absolute top-[520px] lg:top-[610px] xl:top-[625px] w-full -z-50 md:hidden"
      />
      <img
        src="images/element-bg-5.png"
        alt="bg"
        className="hidden absolute md:top-[370px] lg:top-[460px] xl:top-[550px] w-full -z-50 md:block"
      />
      <img
        src="images/element-bg-8.png"
        alt="bg"
        className="hidden absolute md:top-[700px]  w-full -z-50 md:block"
      />
      <img
        src="images/element-bg-8.png"
        alt="bg"
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-start lg:gap-x-[120px]">
          ...
          <div className="md:w-[60%] lg:w-[70%]">
            ...
            <p className="mt-[10px] text-justify text-xs font-mulish text-gray-600 md:text-[14px] lg:text-[16px] xl:text-[18px]">
              Minat generasi muda menggeluti bidang pertanian masih sangat
            ...
            <p className="mt-[10px] text-justify text-xs font-mulish text-gray-600 md:text-[14px] lg:text-[18px]">
              Kementerian Pertanian RI memiliki program yang bertujuan
      ...
      <section className="mt-[40px] ml-[20px] mr-[20px] md:ml-[40px] md:mr-[40px] lg:ml-[70px] lg:mr-[70px] xl:ml-[70px] xl:mr-[70px] xl:mt-[88px]">
        <div className="flex flex-col md:flex-row md:justify-between">
          ...
          <div className="md:w-[70%] md:pr-[20px] lg:w-[70%]">
            ...
            <div>
              <p className="mt-[10px] text-justify text-xs font-mulish text-gray-600 md:text-[14px] lg:text-[16px] xl:text-[18px]">
                Tani Mas merupakan kegiatan budidaya pertanian yang dilaksanakan
      ...
      <section className="mt-[50px] ml-[20px] mr-[20px] md:ml-[40px] md:mr-[40px] lg:ml-[70px] lg:mr-[70px] xl:ml-[70px] xl:mr-[70px] xl:mt-[104px] ">
        ...
        <div className="mt-[22px] grid grid-cols-1 gap-[10px] md:grid-cols-2 md:gap-x-[40px] md:gap-y-[20px] md:mt-[30px] lg:mt-[36px] lg:gap-x-[120px]   xl:mt-[36px] xl:gap-x-[40px] xl:gap-y-[30px] xl:mr-[-30px]">
          <Card
            imageSrc="/images/card/card-1.png"
            title="Lokasi Sekolah"
            description="Sekolah berlokasi di Ibukota Provinsi atau di Kabupaten/Kota terdekat dengan Ibukota provinsi"
          />
          <Card
            imageSrc="/images/card/card-2.png"
            title="Lokasi Sekolah"
            description="Memiliki lahan / kebun sekolah minimal 500 m2"
          />
          <Card
            imageSrc="/images/card/card-3.png"
            title="Sumber Air"
            description="Terdapat sumber air untuk budidaya pertanian"
          />
          <Card
            imageSrc="/images/card/card-4.png"
            title="Ekstrakurikuler"
            description="Diutamakan yang memiliki ekstrakurikuler pertanian"
          />
          <Card
            imageSrc="/images/card/card-5.png"
            title="Dukungan Pihak Sekolah"
            description="Pihak sekolah (guru dan siswa) proaktif dan bersemangat dalam kegiatan ini"
          />
          <Card
            imageSrc="/images/card/card-6.png"
            title="Rumah Bibit"
            description="Mempunyai lahan untuk membangun rumah bibit minimal 15 m2."
          />
        </div>
      </section>
